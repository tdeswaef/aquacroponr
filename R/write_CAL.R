...
write_CAL <- function(Scenario_){
  ...
  plantdate <- Plant_Date %>% yday()
  cat('Calendar file ', Scenario_, ' \n',
      '7.0  : AquaCrop Version (August 2022)\n',
      '0    : The onset of the growing period is fixed on a specific date\n',
      '-9    : Day-number (Table 6) of the Start of the time window for the onset criterion\n',
      '-9    : Length (days) of the time window for the onset criterion\n',
      plantdate, '  : Day-number (Table 6) for the onset of the growing period if fixed on a specific date (switch = 0 in line 3)\n',
