...
#' `cycle_length` an integer representing the length of the **simulation** period in days, `defaultpar` is the default parameter list as designed by the `read_CRO` function and
