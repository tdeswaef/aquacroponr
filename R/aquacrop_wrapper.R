...
#' @param cycle_length a vector with two elements: the first is the start of the simulation period, the second is the length of the simulation period in days
